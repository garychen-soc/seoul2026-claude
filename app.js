...
const TRIP = {
  ...
  pay: {
    note: "依你的條件試算（悠遊付：非新戶＋綁元大；台灣Pay 暑假 20%；中信 uniopen＋星展 eco）。回饋按「每會員／每卡」每月計，行程全在 7 月單月。",
    ladder: [
      ...
      { step: "4", q: "uniopen 滿／7月加碼失效", use: "星展 eco", rate: "淨 ~3.5%", d: "刷到加碼滿約 $15,000；之後回 uniopen 基礎 3%" },
    ],
    tools: [
